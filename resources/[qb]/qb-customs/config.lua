...
vehicleCustomisation = {
    {category = "Đuôi Chắn Gió", id = 0},
    {category = "Bộ đệm phía trước", id = 1},
    {category = "Bộ đệm phía sau", id = 2},
    {category = "Viền Bậc Xe", id = 3},
    {category = "Ống bô", id = 4},
    {category = "Lồng Xe", id = 5},
    {category = "Lưới tản nhiệt", id = 6},
    {category = "mui xe", id = 7},
    {category = "Chắn Bùn Trái", id = 8},
    {category = "Chắn Bùn Phải", id = 9},
    {category = "Trần Xe", id = 10},
    {category = "Nâng Cấp Động Cơ", id = 11},
    {category = "Nâng cấp phanh", id = 12},
    {category = "Nâng cấp đường truyền", id = 13},
    {category = "Nâng Cấp Gầm Xe", id = 15},
    {category = "Nâng Cấp Giáp", id = 16},
    {category = "Nâng cấp Turbo", id = 18},
    {category = "Biển Xe Vanity", id = 25},
    {category = "Trim A", id = 27},
    {category = "Đồ trang trí", id = 28},
    {category = "bảng điều khiển", id = 29},
    {category = "Hộp Số", id = 30},
    {category = "Dán Bên Trong Cửa Xe", id = 31},
    {category = "Ghế ngồi", id = 32},
    {category = "Vô lăng", id = 33},
    {category = "Cần Số", id = 34},
    {category = "Plaque", id = 35},
    {category = "Loa", id = 36},
    {category = "Cốp Xe", id = 37},
    {category = "Thủy lực", id = 38},
    {category = "Khối động cơ", id = 39},
    {category = "Bộ lọc khí", id = 40},
    {category = "Khung Động Cơ", id = 41},
    {category = "Nắp vòm", id = 42},
    {category = "Trang Trí Đầu Xe", id = 43},
    {category = "Trim B", id = 44},
    {category = "Bình xăng", id = 45},
    {category = "Cửa sổ", id = 46},
    {category = "Decal Dán Xe", id = 48},
    {category = "Còi Xe", id = 14,
        hornNames = {
