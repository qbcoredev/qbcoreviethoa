...
Ticker = {
    ...
    Api_key = '30fa76f08ecb7bc9d8e82a511c9e71bdc3231284d44b13a23a114ee2148148b5', -- If you decide to get an api key for the API (https://min-api.cryptocompare.com/pricing) The free plan should be more than enough for 1 Fivem server
