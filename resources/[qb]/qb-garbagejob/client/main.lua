                ...
                options = {
                    {
                        ...
                        label = 'Nói chuyện với người tái chế rác',
            ...
            if options then
                ...
                zone:onPlayerInOut(function(inside)
                    if LocalPlayer.state.isLoggedIn then
                        if inside then
                            exports['qb-core']:DrawText("[E] Nói chuyện với người tái chế rác", 'left')
                            Listen4Control()
                        else
                            ControlListen = false
                            exports['qb-core']:HideText()
...
RegisterNetEvent('qb-garbagejob:client:MainMenu', function()
    local MainMenu = {
        ...
        {
            header = "Nhận Lương",
            txt = "Làm việc và nhận lương tại đây!",
            params = {
                event = 'qb-garbagejob:client:RequestPaycheck',
            }
        },
        {
            header = "Yêu cầu thêm việc",
            txt = "Yêu cầu thêm việc",
            params = {
